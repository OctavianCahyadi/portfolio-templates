...
export const BlogPage = ({ landingPageData }: BlogPageProps) => {
  // Extract data from landingPageData structure
  const profile = landingPageData.profile || {};
  const posts = []; // Blog posts would be fetched separately
  const categories = []; // Categories would be fetched separately
